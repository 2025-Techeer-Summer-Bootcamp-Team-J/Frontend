  ...
  return (
    <Section id="care">
      <ContentWrapper>
        ...
        <GradientText>
          <span style={{ fontSize: '2rem', fontWeight: 500, display: 'block' }}>
            삐까뻔쩍이 제공하는
          </span>
          <span style={{ fontSize: '1.8rem', fontWeight: 800, color: '#05A6FD', display: 'block' }}>
            핵심 기능 3가지
          </span>
        </GradientText>
        ...
        <Grid md_cols="3" gap="2rem">
          <FeatureBox>
            ...
            <GlassmorphismCard> 
              <p className="text-gray-600">
                사진 한 장으로 주요 고민 분석합니다. 시간과 장소에 구애받지 않고 전문가 수준의 진단을 받아보세요.
              </p>
            </GlassmorphismCard>
          </FeatureBox>
          ...
          <FeatureBox>
            ...
            <GlassmorphismCard>
              <p className="text-gray-600">
                분석 결과를 바탕으로 당신의 피부 타입과 고민에 가장 적합한 생활 습관을 추천해 드립니다. 더 이상 추측에 의존하지 마세요.
              </p>
            </GlassmorphismCard>
          </FeatureBox>
          ...
          <FeatureBox>
            ...
            <GlassmorphismCard>
              <p className="text-gray-600">
                피부 변화를 기록하고 시각적인 리포트를 통해 개선 과정을 한눈에 확인하세요. 꾸준한 관리가 아름다운 피부의 비결입니다.
              </p>
            </GlassmorphismCard>
          </FeatureBox>
        </Grid>
